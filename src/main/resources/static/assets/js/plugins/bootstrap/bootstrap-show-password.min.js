 ...
 (function(a, b) {
	...
	var k, l, m, n = {}.toString,
		...
		w = function(a, b) {
			if (!q(a)) return a;
			var c, d;
			if (b && "function" == typeof(c = a.toString) && !q(d = c.call(a))) return d;
		...
		z = "object" == typeof window && window && window.Math == Math ? window : "object" == typeof self && self && self.Math == Math ? self : Function("return this")(),
		A = z.document,
		...
		G = y ? F : function(a, b, c) {
			if (E(a), b = w(b, !0), E(c), D) try {
				return F(a, b, c)
			} catch (a) {}
		...
		N = Math.random(),
		O = function(a) {
			return "Symbol(".concat(a === void 0 ? "" : a, ")_", (++M + N).toString(36))
		},
		P = !x(function() {
			return !(Symbol() + "")
		}),
		...
		U = function(a, b) {
			var c;
			return p(a) && (c = a.constructor, "function" == typeof c && (c === Array || p(c.prototype)) ? c = void 0 : q(c) && (c = c[T], null === c && (c = void 0))), new(void 0 === c ? Array : c)(0 === b ? 0 : b)
		},
		V = S("species"),
		...
		ga = y ? fa : function(a, b) {
			if (a = ca(a), b = w(b, !0), D) try {
				return fa(a, b)
			} catch (a) {}
	...
	var va = {
			...
			getterFor: function(a) {
				return function(b) {
					var c;
					if (!q(b) || (c = l(b)).type !== a) throw TypeError("Incompatible receiver, " + a + " required");
					return c
				}
			}
		},
		wa = b(function(a) {
			...
			L("inspectSource", function(a) {
				...
				var g = !!f && !!f.unsafe,
					h = !!f && !!f.enumerable,
					i = !!f && !!f.noTargetGet;
				return ("function" == typeof e && ("string" == typeof b && !ea(e, "name") && J(e, "name", b), c(e).source = d.join("string" == typeof b ? b : "")), a === z) ? void(h ? a[b] = e : K(b, e)) : void(g ? !i && a[b] && (h = !0) : delete a[b], h ? a[b] = e : J(a, b, e))
		...
		Ca = Object.getOwnPropertyNames || function(a) {
			return za(a, Ba)
		},
		Da = {
			f: Ca
		...
		Ga = z.Reflect,
		Ha = Ga && Ga.ownKeys || function(a) {
			var b = Da.f(E(a)),
				c = Fa.f;
			return c ? b.concat(c(a)) : b
		},
		Ia = function(a, b) {
			for (var c, d = Ha(b), e = f.f, g = ha.f, h = 0; h < d.length; h++) c = d[h], ea(a, c) || e(a, c, g(b, c))
		},
		Ja = /#|\.prototype\./,
		Ka = function(a, b) {
			var c = Ma[La(a)];
		...
		Qa = function(a, b) {
			...
			if (d = j ? z : k ? z[i] || K(i, {}) : (z[i] || {}).prototype, d)
				for (e in b) {
					if (g = b[e], a.noTargetGet ? (h = Pa(d, e), f = h && h.value) : f = d[e], c = Ka(j ? e : i + (k ? "." : "#") + e, a.forced), !c && void 0 !== f) {
	...
	var Xa = function(a) {
		...
		Ya = function(d, e, f) {
			return (Xa(d), void 0 === e) ? d : 0 === f ? function() {
				return d.call(e)
			} : 1 === f ? function(b) {
				return d.call(e, b)
			} : 2 === f ? function(c, a) {
		...
		$a = y ? Object.defineProperties : function(a, b) {
			E(a);
			for (var c, d = Za(b), e = d.length, g = 0; e > g;) f.f(a, c = d[g++], b[c]);
			return a
		},
		_a = z.document,
		...
		eb = function() {
			var a, b = C("iframe"),
				...
				e = "script",
				f = ">";
			for (b.style.display = "none", ab.appendChild(b), b.src = "java" + e + ":" + "", a = b.contentWindow.document, a.open(), a.write(d + e + f + "document.F=Object" + d + "/" + e + f), a.close(), eb = a.F; c--;) delete eb[cb][Aa[c]];
			return eb()
		},
		fb = Object.create || function(a, b) {
			var c;
			return null === a ? c = eb() : (db[cb] = E(a), c = new db, db[cb] = null, c[bb] = a), void 0 === b ? c : $a(c, b)
		};
	na[bb] = !0;
	...
	var ib = function(a, b) {
			...
			return function(b, g, h) {
				for (var i, j, k = s(b), l = ba(k), m = Ya(g, h, 3), n = v(l.length), o = 0, p = c ? f(b, n) : 2 == a ? f(b, 0) : void 0; n > o; o++)
	...
	var ob = "[\t\n\x0B\f\r \xA0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF]",
		...
		qb = RegExp(ob + ob + "*$"),
		rb = function(a, b) {
			return a = r(a) + "", 1 & b && (a = a.replace(pb, "")), 2 & b && (a = a.replace(qb, "")), a
		},
		sb = z.parseInt,
		tb = /^[-+]?0[xX]/,
	...
	var wb = function() {
		...
		Ab = function() {
			var a = /a/,
				b = /b*/g;
			return xb.call(a, "a"), xb.call(b, "a"), 0 !== a.lastIndex || 0 !== b.lastIndex
		}(),
		Bb = /()??/.exec("")[1] !== void 0;
	(Ab || Bb) && (zb = function(a) {
		var b, c, d, e, f = this;
		return Bb && (c = new RegExp("^" + f.source + "$(?!\\s)", wb.call(f))), Ab && (b = f.lastIndex), d = xb.call(f, a), Ab && d && (f.lastIndex = f.global ? d.index + d[0].length : b), Bb && d && 1 < d.length && yb.call(d[0], c, function() {
	...
	var Db = function(a, b, c) {
			var d, e, f = r(a) + "",
				g = u(b),
				h = f.length;
			return 0 > g || g >= h ? c ? "" : void 0 : (d = f.charCodeAt(g), 55296 > d || 56319 < d || g + 1 === h || 56320 > (e = f.charCodeAt(g + 1)) || 57343 < e ? c ? f.charAt(g) : d : c ? f.slice(g, g + 2) : (d - 55296 << 10) + (e - 56320) + 65536)
		},
		Eb = function(a, b, c) {
		...
		Fb = function(a, b) {
			...
			if ("RegExp" !== o(a)) throw TypeError("RegExp#exec called on incompatible receiver");
			return Cb.call(a, b)
		},
		Gb = S("species"),
		Hb = !x(function() {
	...
	(function(a, b, c, d) {
		var e = S(a),
			...
			g = f && !x(function() {
				...
				return c.exec = function() {
					return b = !0, null
				}, "split" === a && (c.constructor = {}, c.constructor[Gb] = function() {
					return c
				}), c[e](""), !b
			});
		if (!f || !g || "replace" === a && !Hb || "split" === a && !Ib) {
			var h = /./ [e],
				...
				j = i[0],
				k = i[1];
			wa(String.prototype, a, j), wa(RegExp.prototype, e, 2 == b ? function(a, b) {
		...
		function d(a, c, d, e, g, h) {
			var i = d + a.length,
				k = e.length,
				f = Kb;
			return void 0 !== g && (g = s(g), f = Jb), b.call(h, f, function(b, h) {
				var l;
				switch (h.charAt(0)) {
					case "$":
						return "$";
					...
					default:
						...
						if (m > k) {
							var n = j(m / 10);
							return 0 === n ? b : n <= k ? void 0 === e[n - 1] ? h.charAt(1) : e[n - 1] + h.charAt(1) : b
						}
						l = e[m - 1];
				}
				return void 0 === l ? "" : l
		...
		return [function(c, d) {
			...
			for (var r = "", s = 0, t = 0; t < p.length; t++) {
				o = p[t];
				for (var w = o[0] + "", x = h(i(u(o.index), k.length), 0), y = [], z = 1; z < o.length; z++) y.push(Lb(o[z]));
				var A = o.groups;
				if (l) {
	...
	var Ob = {
			html: {
				inputGroups: {
					...
					4: ["<div class=\"%s\"><button tabindex=\"100\" title=\"%s\" class=\"btn btn-light\" type=\"button\">", "</button></div>"]
				}[Mb]
			}
		},
		Pb = function(a) {
		...
		Qb = function() {
			...
			return g(b, [{
				...
				key: "show",
				value: function(b) {
					var c = a.Event("show.bs.password", {
						relatedTarget: b
					});
					this.$element.trigger(c), this.isShown = !0, this.$element.hide(), this.$text.show(), this.options.eyeClassPositionInside ? this.$icon.find("i,svg").removeClass("icon-eye-open").addClass("icon-eye-close").html(this.options.eyeCloseClass) : this.$icon.find("i,svg").removeClass("icon-eye-open ".concat(this.options.eyeOpenClass)).addClass("icon-eye-close ".concat(this.options.eyeCloseClass)), this.$text[this.options.placement](this.$element)
				}
			}, {
				key: "hide",
				value: function(b) {
					var c = a.Event("hide.bs.password", {
						relatedTarget: b
					});
					this.$element.trigger(c), this.isShown = !1, this.$element.show(), this.$text.hide(), this.options.eyeClassPositionInside ? this.$icon.find("i,svg").removeClass("icon-eye-close").addClass("icon-eye-open").html(this.options.eyeOpenClass) : this.$icon.find("i,svg").removeClass("icon-eye-close ".concat(this.options.eyeCloseClass)).addClass("icon-eye-open ".concat(this.options.eyeOpenClass)), this.$element[this.options.placement](this.$text)
				}
			}, {
				key: "val",
				value: function(a) {
					return "undefined" == typeof a ? this.$element.val() : void(this.$element.val(a).trigger("change"), this.$text.val(a))
				}
			}, {
				key: "focus",
				value: function() {
	...
	a.fn.password = function() {
		...
		return this.each(function() {
			...
			if ("string" == typeof d) {
				if (0 > a.inArray(d, f)) throw new Error("Unknown method: ".concat(d));
				b = h[d](e[1])
			} else h ? h.init(i) : (h = new Qb(g, i), g.data("bs.password", h))
		}), b ? b : this
	}, a.fn.password.Constructor = Qb, a.fn.password.noConflict = function() {
		return a.fn.password = Rb, this
	}, a(function() {
		a("[data-bs-toggle=\"password\"]").password()
	})
});